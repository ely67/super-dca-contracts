...
async function main() {
    ...
    const INVERT_PRICE = process.env.INVERT_PRICE || false;
    ...
    await pool.deployed();
    // Attach to the existing pool
    // const pool = await SuperDCAPoolV1.attach("0x4507d2B91736A615131A28c3DCcDEb66E975FA97");
